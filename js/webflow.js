...
Webflow.require('ix').init([
  {"slug":"aparece","name":"aparece","value":{"style":{"opacity":0,"x":"0px","y":"0px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"20%","stepsA":[{"opacity":1,"transition":"opacity 200 ease 0"}],"stepsB":[{"opacity":1,"transition":"opacity 200 ease 0"}]}]}},
  {"slug":"ani","name":"ani","value":{"style":{"opacity":0},"triggers":[{"type":"load","preload":true,"stepsA":[{"wait":"2600ms","opacity":1,"transition":"opacity 200 ease 0"}],"stepsB":[]}]}}
]);
